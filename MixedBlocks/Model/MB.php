...
namespace Tbb\MixedBlocks\Model;

use Tbb\MixedBlocks\Model\MB\FileInfo;
use Magento\Framework\App\ObjectManager;
use Magento\Store\Model\StoreManagerInterface;

class MB extends \Magento\Framework\Model\AbstractModel
{
    /**
     * MB cache tag
     */
    const CACHE_TAG = 'tbb_mixed_blocks';
    ...
    {
        $this->_init('Tbb\MixedBlocks\Model\ResourceModel\MB');
    }

    /**
     * Prepare mb's statuses.
     *
     * @return array
     */
